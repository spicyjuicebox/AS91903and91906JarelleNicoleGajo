...
# Checks that the password and email entered are both correct.
# When successfully logged in, a flash message will tell the user that they have logged in successfully.
...
# This function creates the route for the sign up page.
# Takes data from the sign up form.
# Validates that the email and username are not already in use.
# Validates that the email is greater than 4 characters.
# Validates that the email ends with @gmail.com or @my.sanctamaria.school.nz.
# Validates that the username is greater than 1 character.
# Validates that the password is at least 8 characters.
# Checks that the password and confirm password entered match.
# When the user signs up, the database is updated with their new account.
# When successfully signing up, a flash message will tell the user that they have signed up successfully.
# After signing up, the user is logged in and will be directed to the home page.
...
# This function creates the route for the logout page.
# When the user logs out, a flash message will tell the user that they have logged out successfully.
# After logging out, the user will be directed to the log in page.
@auth.route("/logout")
@login_required
def logout():
    logout_user()
